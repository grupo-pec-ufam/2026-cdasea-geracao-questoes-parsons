...
Escreva um programa que leia a leitura de radiação de cada amostra e informe o nível de segurança correspondente à média das duas leituras.

**Entrada:** 
1. Corresponde a leitura inteira da primeira amostra.
2. Corresponde a leitura inteira da segunda amostra.

**Saída:**
1. Informe a classificação de segurança da radiação. 
2. imprima a média de radiação arredondada para uma casa decimal.
